...
Case "lc_app".
  inversion LC.
  destruct IH0; subst... inversion H6... right; exists E_hole; eapply ex_intro... 
  destruct IH; subst... inversion H3... right; exists E_hole; eapply ex_intro...
  destruct_decomp e2...
  destruct_decomp e1...
Case "lc_set".
  inversion LC.
...
destruct_decomp e...
right.
assert (ae ae). apply decompose_ae in H...
...
Case "step_err"; auto.
Case "step_red".
  apply lc_red in H2... apply lc_plug with (ae := ae) (e := e)...
